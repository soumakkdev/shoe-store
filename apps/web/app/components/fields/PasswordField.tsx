		...
		return (
			<div className="space-y-3">
				<div className="flex items-center justify-between">
					...
					{showStrength ? <span className="text-xs text-muted-foreground">{getStrengthText(strength)}</span> : null}
				</div>
				...
				{showStrength ? (
					<div className="h-1 w-full bg-zinc-200 rounded-full">
						<div
							className={cn('h-full rounded-full transition-all duration-500', getStrengthColor(strength))}
							style={{
